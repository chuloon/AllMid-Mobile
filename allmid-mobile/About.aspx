<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="allmid_mobile.About" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent2" runat="server">
    ...
    <div class="about-container text-field">
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent3" runat="server">
    ...
    <div class="about-container center">
        ...
        <div class="about-container center">
            ...
            <p class="about-left text-field">A rising star in the E-sports community, Stelanie brings together passion for gaming and a profound understanding for marketing.  She plans and hosts an annual convention at Miami University.  She also is heavily involved Miami’s student government association.</p>
        ...
        <div class="about-container center">
            ...
            <p class="about-left text-field">Albert Maah has ran gaming organizations since his days in high school.  He currently sits on the executive staff of E-sports Initiative at Ohio State, and helps host Shuffle - the largest Super Smash Brothers game tournament in the region.  In addition to his work with ESI, Albert has worked with MLG at their esports arena in Columbus.</p>
        ...
        <div class="about-container center">
            ...
            <p class="about-left text-field">A Hong Kong native, Sebastian attends Case Western Reserve University in Cleveland, OH, where he is president of the Case League of Legends club.  He holds a passion for community engagement and has a broad network for bringing gamers across the region together. </p>
        ...
        <div class="about-container center">
            ...
            <p class="about-left text-field">Located in Cleveland, OH, Nicholas is a lawyer that specializes in contract and tech. law.  Having worked for high profile companies like IBM, Nick now owns his own practice.  In his spare time, he works to develop and promote accessible esports platforms for aspiring competitive gamers.    </p>
